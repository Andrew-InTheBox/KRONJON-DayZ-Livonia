...
start "DayZ Server" /min DayZServer_x64.exe -config=%serverConfig% -mod=%mods% -port=%serverPort% -profiles=%serverProfile% -cpuCount=%serverCPU% -adminlog -netlog -freezecheck 
